...
import 'package:patients/repositories/calculate_total_duty_hours.dart';
import 'package:patients/repositories/duties_repository.dart';
...
class DutyRosterBloc extends Bloc<DutyRoster> {
  ...
  int get totalHours {
    final duration = caculateTotalDutyHours(dutiesRepository.value);
