...
import 'package:patients/repositories/user_repository.dart';
...
class UserBloc extends Bloc<UserPage> {
  ...
  Duration get jobDuration => userRepository.value.jobDuration;
  String get name => userRepository.value.name;
  ShowDurationIn get showDurationIn => userRepository.value.showDurationIn;
  DateTime get jobStartedOn => userRepository.value.jobStartedOn;
