...
import 'package:patients/ui/patients/patient/patient_page_v2.dart';

class PatientTile extends UI with InheritedPatient {
  PatientTile({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          navigator.to(
            patientRM.reInherited(
              context: context,
              builder: (context) => PatientPage(),
            ),
          );
        },
        // onLongPress: () => navigator.to(
        //   patientRM.reInherited(
        //     context: context,
        //     builder: (context) => PatientPage(),
        //   ),
